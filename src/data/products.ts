...
export const collections: Collection[] = [
  ...
  },
  {
    ...
    subtitle: "Small batches from our Rajasthan atelier",
...
export const products: Product[] = [
  {
    ...
    description:
      "A sun-faded co-ord born in our Rajasthan atelier — block-printed cotton with hand-finished edges. Wears like memory.",
    ...
    artisan: "Stitched by Sunita ji & embroidered by the Meena collective in Rajasthan, India.",
  ...
  },
  {
    ...
    artisan: "Cut & sewn in Rajasthan, India; embroidery by Rekha Devi.",
